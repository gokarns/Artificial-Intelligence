...
# Searches the grid to find an entry that is unassigned. If found,the reference parameters row, col will be set the location 
# that is unassigned, and true is returned. If no unassigned entries remain, false is returned. 
# 'l' is a list  variable that has been passed from solve_sudoku function to keep track of incrementation of Rows and Columns 
...
# Takes partially filled-in grid and attempts to assign values to all unassigned locations in such a way to meet the requirements 
